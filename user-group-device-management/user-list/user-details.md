...
You can add a setting assigned to this user using <img src="../../.gitbook/assets/image (3).png" alt="" data-size="line">, alternatively open an existing setting by clicking on its name/key or search for a setting by name/key.
