...
Nearly every package in the [Package Store](packages/package-store/) can be deployed to your Windows devices in one of two ways. You choose the method per package when you [subscribe](packages/package-store/package-store-details.md#subscription) to it, and you manage assignments the same way afterwards through [managed groups](packages/package-deployment.md).
...
{% hint style="info" %}
We recommend RealmJoin deployment. It supports everything the Intune method does and adds the capabilities described on this page. If you have decided to standardise on Intune-managed packages instead, see the [Migration Guide](packages/migration-guide-realmjoin-to-intune-managed-packages.md).
{% endhint %}
...
<table data-view="cards"><thead><tr><th></th><th></th><th data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><strong>Subscribe &#x26; assign</strong></td><td>How to subscribe a package for either method and assign it to managed groups.</td><td><a href="packages/package-store/package-store-details.md">package-store-details.md</a></td></tr><tr><td><strong>Expert Settings</strong></td><td>Full reference for the per-package options compared above.</td><td><a href="packages/package-settings.md">package-settings.md</a></td></tr><tr><td><strong>Migrate to Intune</strong></td><td>If you have decided to standardise on Intune-managed packages.</td><td><a href="packages/migration-guide-realmjoin-to-intune-managed-packages.md">migration-guide-realmjoin-to-intune-managed-packages.md</a></td></tr></tbody></table>
