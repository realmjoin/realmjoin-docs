...
<figure><img src="../../.gitbook/assets/image (237).png" alt=""><figcaption><p>Package Automation</p></figcaption></figure>
...
These values can be globally preconfigured for newly imported packages in [Settings](../../administration-and-settings/settings.md). Configuring them on a per package basis will overwrite the global defaults.

## Config

<figure><img src="../../.gitbook/assets/image (328).png" alt=""><figcaption><p>Package Config</p></figcaption></figure>
...
![Technical Help for a Package](<../../.gitbook/assets/image (72).png>)
