...
* Access to all features of [Application Management](../../application-management/packages/)
...
* Read-only access to all features of [Application Management](../../application-management/packages/)
...
* Access to [Application Management](../../application-management/packages/)
