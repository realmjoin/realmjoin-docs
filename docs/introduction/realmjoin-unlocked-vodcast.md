...
## Special: Onboarding a RealmJoin Tenant in Minutes <a href="#special-1" id="special-1"></a>
...
## Episode 2: RealmJoin Self-Service update <a href="#episode-2" id="episode-2"></a>
...
## Episode 1: Wrap-up & What's New <a href="#episode-1" id="episode-1"></a>

{% embed url="https://www.youtube.com/watch?v=pm-VfgOB1kc" %}

In the kick-off episode, Moritz and **Steffen Schwerdtfeger (Cloud Architect & RealmJoin Champion)** take a deep dive into the evolution of RealmJoin over the last 12 to 18 months. They discuss how the product has transitioned from a specialized patch management tool to a comprehensive "Companion to Intune."
