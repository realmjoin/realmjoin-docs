...
To see information about the Initial Start before version 4.15, navigate to the [Appendix](../appendix/initial-before-v415.md)
...
Furthermore RealmJoin offers a remote function (**Start remote session**). For more information about this function in RealmJoin, go to the [AnyDesk](../support/anydesk.md) section.
