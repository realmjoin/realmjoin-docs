...
title: Installation of RealmJoin
description:
keywords:
author: 
editor: lars.thiele
...
* The **realmjoin.exe** process is started up automatically on Logon. The process is always running and sends upstream data (compare to section [RealmJoin Portal](../usage/realmjoin-portal.md#states) every 15 minutes.
