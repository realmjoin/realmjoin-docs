...
After the successful deployment, the package can be found in the Chocolatey library and added. See section [Managing RealmJoin](../usage/managing-realmjoin.md) for information on assigning packages.  
