...
description: >-
  Diagnose failed Chocolatey package installs by understanding the install
  stages and finding error messages in the logs.
---
...
* Network problem, when the RealmJoin nuget server cannot be reached, (see [#realmjoin-connection-endpoints](../../../deployment/infrastructure/#realmjoin-connection-endpoints "mention")):
