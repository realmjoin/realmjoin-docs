...
description: >-
  RealmJoin information security, data processing, and privacy FAQ, covering
  data centers, storage, and quality assurance.
---
...
Please refer to [Required Permissions](../deployment/required-permissions.md).
...
Yes. The RealmJoin Admin portal provides features to assign [roles](../administration-and-settings/permission/) to every user.
