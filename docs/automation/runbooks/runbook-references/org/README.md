---
title: Organization Runbook Overview
---

# Organization Runbook Overview

Here you can find all Organization Runbooks along with the available subcategories.
...
## General
  ...
  - [Assign Groups By Template (Scheduled)](general/assign-groups-by-template_scheduled.md)
  ...
  - [Check Aad Sync Status (Scheduled)](general/check-aad-sync-status_scheduled.md)
  ...
  - [Check Device Onboarding Exclusion (Scheduled)](general/check-device-onboarding-exclusion_scheduled.md)
  - [Enrolled Devices Report (Scheduled)](general/enrolled-devices-report_scheduled.md)
  ...
  - [Export Cloudpc Usage (Scheduled)](general/export-cloudpc-usage_scheduled.md)
...
## Mail
  ...
  - [Hide Mailboxes (Scheduled)](mail/hide-mailboxes_scheduled.md)
