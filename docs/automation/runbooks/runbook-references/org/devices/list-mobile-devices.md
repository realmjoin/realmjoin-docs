...
description: Lists all managed mobile devices (Android, iOS/iPadOS) with mobile-specific inventory, security and network details.
---
...
## Location
Organization → Devices → List Mobile Devices

**Full Runbook name**

rjgit-org_devices_list-mobile-devices
...
- **Type**: Microsoft Graph
  - DeviceManagementManagedDevices.Read.All
    - *Lists Intune managed mobile devices including hardware, SIM and network details*
  - Directory.Read.All *(optional — feature: Group scope filtering)*
    - *Reads group members to resolve the optional device/user group scope filters*
  - Organization.Read.All *(optional — feature: Email report / download link)*
...
| Default Value | False |
| Type | Boolean |
| Portal display name | Include network/SIM details (one extra Graph call per device - slower on many devices) |
...
| Default Value | True |
| Type | Boolean |
| Portal display name | Include phone numbers in the output |
...
| Default Value |  |
| Type | String |
| Portal display name | Limit to primary users in group (optional) |
...
| Default Value |  |
| Type | String |
| Portal display name | Recipient Email Address(es) (optional - leave empty for job output only) |
