...
<figure><img src="../../../.gitbook/assets/image (101).png" alt=""><figcaption><p>Runbook Job List</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (109).png" alt=""><figcaption><p>Runbook Job Details</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (232).png" alt=""><figcaption><p>Scheduled Jobs</p></figcaption></figure>
...
Azure Automation will only keep runbook job logs for a limited time. RealmJoin offers to copy/archive runbook logs into a Log Analytics Workspace to preserve them for a longer time. This will only be available after you've correctly configured/onboarded [Log Analytics](../../../monitoring-and-logs/log-analytics.md).
...
<figure><img src="../../../.gitbook/assets/image (257).png" alt=""><figcaption><p>Archived Runbook Job Logs List</p></figcaption></figure>
