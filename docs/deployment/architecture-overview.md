...
* **Process Automation** – runbooks that run in _your own_ Azure Automation account.
...
For details on package delivery and BranchCache, see [Infrastructure Considerations](infrastructure/).
