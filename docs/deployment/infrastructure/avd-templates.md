...
<figure><img src="../../.gitbook/assets/image (172).png" alt=""><figcaption><p>Templates List</p></figcaption></figure>

2. Select the <img src="../../.gitbook/assets/image (163).png" alt="" data-size="line"> icon (1), enter a meaningful name (2) and Click "Save" (3).
...
2. To add packages to the template, click the <img src="../../.gitbook/assets/image (163).png" alt="" data-size="line"> icon.

<figure><img src="../../.gitbook/assets/image-2.png" alt=""><figcaption><p>Add packages to a template - 1</p></figcaption></figure>

3. Search for a package and hit the ![](<../../.gitbook/assets/image (200).png>) icon to add it to your template. The list represents all RealmJoin packages you have subscribed to in your environment.
...
2. Click the <img src="../../.gitbook/assets/image (163).png" alt="" data-size="line"> icon (1), enter a meaningful name (2) and click **Save** (3).
...
<figure><img src="../../.gitbook/assets/image (192).png" alt=""><figcaption><p>Find template ID and token</p></figcaption></figure>
